     ...
     <!-- Website font  -->
        ...
        <div class="footer-container">
            ...
            <div class="footer-section">
                ...
                <p>Association dédiée à la promotion de l'archéologie et des technologies de l'information.</p>
            ...
            <div class="footer-section">
                ...
                <ul class="contact-info">
                    ...
                    <li><i class="fas fa-map-marker-alt"></i> 123 Rue de l'Archéologie, 75000 Paris</li>
                </ul>
            </div>
